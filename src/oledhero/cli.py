...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.set_defaults(handler=_cmd_hello)
    ...
    hello_world = subparsers.add_parser(
        "hello", help="Display a hello message."
    )
    hello_world.add_argument(
        "--name", required=True, help="Name of the user to greet."
    )
    goodbye = subparsers.add_parser(
        "bye", help="Display a goodbye message."
    )
